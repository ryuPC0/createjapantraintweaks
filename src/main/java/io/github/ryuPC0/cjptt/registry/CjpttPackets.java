...
import io.github.ryuPC0.cjptt.speedSign.advanced.AdvancedSpeedSignbePacket;
import io.github.ryuPC0.cjptt.speedSign.advanced.AdvancedSpeedSignedgePacket;
...
public enum CjpttPackets {
    ...
    ADVSIGN_CLIENT(AdvancedSpeedSignedgePacket.class,AdvancedSpeedSignedgePacket::new,PLAY_TO_CLIENT),
    ADVSIGN_APPLY(AdvancedSpeedSignbePacket.class, AdvancedSpeedSignbePacket::new,PLAY_TO_SERVER);
    ...
    <T extends SimplePacketBase> CjpttPackets(Class<T> type, Function<FriendlyByteBuf, T> factory,
    ...
    public static void registerPackets() {
        ...
        for (CjpttPackets packet : values())
