...
public class CjpttBlockEntities {
    ...
    public static final BlockEntityEntry<AdvancedSpeedSignBlockEntity> ADVANCEDSPEEDSIGN_BLOCKENTITY = REGISTRATE.get().blockEntity("advancedspeedsign",AdvancedSpeedSignBlockEntity::new).validBlock(ADVANCED_SPEEDSIGN_BLOCK).register();
